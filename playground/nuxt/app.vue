...
const scaleMoon = useMotionValue(isDark.value ? 1 : 0)
const scaleSun = useMotionValue(isDark.value ? 0 : 1)
const isChecked = computed(() => !isDark.value)
watch(isDark, (value) => {
  scaleMoon.set(value ? 1 : 0)
  scaleSun.set(value ? 0 : 1)
})
